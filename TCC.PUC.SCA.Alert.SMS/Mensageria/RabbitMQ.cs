...
using static TCC.PUC.SCA.Alert.SMS.Mensageria.RabbitMQConectar;

namespace TCC.PUC.SCA.Alert.SMS.Mensageria
{
            ...
            try
            {
                using (var channel = Connection.CreateModel())
                {
                    while (true)
                    {
                        try
                        {
                            BasicGetResult result = channel.BasicGet("SMS", false);
